import { celoFirst, normalizeEvents } from "./EventHelpers";
...
describe("celoFirst", () => {
    it("places the closest event which is celo hosted first", () => {
        expect(example.slice(0).sort(celoFirst).map(simplify)).toEqual(RESULT);
    });
    ...
    const example = [
        ...
        },
        {
            ...
            link: "https://www.iamtn.org/amp/stablecoins-a-safer-bet-for-cross-border-payments-and-remittances",
            celoHosted: false,
            celoSpeaking: true,
            description: undefined,
...
//# sourceMappingURL=EventHelpers.test.js.map