...
export default function BrandKitPage({ sections, title, path, metaDescription }) {
    return (<Page pages={PAGES} sections={sections} title={`BrandKit / ${title}`} path={path} kitName="BrandKit" metaDescription={metaDescription} ogImage={require("src/experience/brandkit/images/ogimage-brandkit.png")}/>);
}
