...
import { NameSpaces, Trans, useTranslation, withNamespaces } from "src/i18n";
import InlineAnchor from "src/shared/InlineAnchor";
import { hashNav } from "src/shared/menu-items";
import { fonts, standardStyles } from "src/styles";
export default React.memo(withNamespaces(NameSpaces.brand)(function Intro({ t }) {
    return (<>
        <Page title="Home" path={ROOT} metaDescription={t("home.introduction")} sections={[
...
const Overview = withNamespaces(NameSpaces.brand)(function _Overview({ t }) {
    return (<View style={brandStyles.gap}>
    ...
    return (<View style={brandStyles.gap}>
      ...
      <Text style={fonts.p}>
        <Trans ns={NameSpaces.brand} i18nKey="home.brandVoiceText">
          <InlineAnchor target="_blank" onPress={onPressVoice} href={"https://docs.google.com/document/d/1Y1mfpBGad_8ZxSuIqwX52MWGEMfoWGt5HXc7sZp9h70/edit?usp=sharing"}>
            ""
          </InlineAnchor>
        </Trans>
      </Text>
