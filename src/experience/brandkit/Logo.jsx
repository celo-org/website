...
export default React.memo(function Logo() {
    ...
    return (<Page title={t("logo.title")} metaDescription={"logo.overviewCopy"} path={LOGO_PATH} sections={[
...
const Overview = React.memo(function _Overview() {
    ...
    return (<View style={styles.container}>
      <View style={styles.gap}>
        ...
        <Button kind={BTN.PRIMARY} text={t("logo.overviewBtn")} onPress={onPressDownload} href="/assets/CeloLogoPackage.zip"/>
      ...
      <View style={styles.tiling}>
        <LogoExample hasBorder={true} logoType={Logos.light} background={colors.white} href="/assets/CeloColorLogo.zip" caption={t("logo.fullColorOnLightCaption")}/>
        <LogoExample hasBorder={false} logoType={Logos.dark} background={colors.dark} href="/assets/CeloColorLogoReverse.zip" caption={t("logo.fullColorOnDarkCaption")}/>
        <LogoExample hasBorder={true} logoType={Logos.black} background={colors.white} href="/assets/CeloMonochromeLogo.zip" caption={t("logo.monochromeCaption")}/>
        <LogoExample hasBorder={false} logoType={Logos.white} background={colors.dark} href="/assets/CeloMonochromeLogoReverse.zip" caption={t("logo.monochromeInverseCaption")}/>
      </View>
      <View style={styles.gap}>
        <Text style={[fonts.h5, standardStyles.elementalMargin, standardStyles.blockMarginTop]}>
          {t("logo.glyphTitle")}
        ...
        <View style={[styles.tiling, standardStyles.elementalMarginTop]}>
          <View style={[standardStyles.centered, glyphAreaStyle, { backgroundColor: colors.faintGray }]}>
          ...
          <View style={[standardStyles.centered, glyphAreaStyle, { backgroundColor: colors.primary }]}>
      ...
      <View style={styles.gap}>
        ...
        <View style={[
          ...
          <AspectRatio ratio={714 / 357} style={styles.clearspaceImage}>
            <Image resizeMethod="resize" resizeMode="contain" source={require("src/experience/brandkit/images/ClearspaceImage.png")} style={standardStyles.image}/>
          </AspectRatio>
        </View>
      </View>
      <View>
    ...
    return (<View>
      ...
      <TripplePairing first={<>
            <Judgement is={Value.Bad}>
              <LogoWithBackground image={require("src/experience/brandkit/images/lilah.jpg")} type="dark"/>
            </Judgement>
            <Judgement is={Value.Good}>
              <LogoWithBackground backgroundColor={colors.dark} image={require("src/experience/brandkit/images/lilahOverlay.jpg")} type="white"/>
            </Judgement>
          </>} second={<>
            <Judgement is={Value.Bad}>
