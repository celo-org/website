    ...
    render() {
        ...
        <View style={[styles.menu, this.state.isOpen && styles.open]}>
          <View style={styles.sideBar}>
            <Sidebar pages={pages} currentPathName={pathname} routeHash={this.props.routeHash} onChangeRoute={this.goToSubSection}/>
          </View>
        </View>
      </View>);
    }
}
function Title({ pages, pathname }) {
...
//# sourceMappingURL=MobileKitMenu.jsx.map