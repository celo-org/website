...
export default React.memo(function DirectoryItem(props) {
    return (<View>
      <View style={styles.logoAndLink}>
        <ContentfulImage image={props.logo} maxHeight={props.logoHeight} maxWidth={props.logoWidth}/>
      ...
      {props.repo && (<a href={props.repo} target="_blank" rel="noopener">
          {" "}
...
function ContentfulImage({ image, maxHeight, maxWidth }) {
    ...
    return (<View style={{
      ...
      {potentialWidth && (<Image source={{ uri: `${image}?w=${realWidth}&h=${realHeight}` }} style={{ width: realWidth, height: realHeight }}/>)}
    </View>);
}
...
//# sourceMappingURL=DirectoryItem.jsx.map