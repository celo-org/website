...
it("renders a collection of Grant Recipients", () => {
    ...
    const { getByText } = render(<DirectorySection name={"Test and Go"} description="Projects that test the bounds" items={items}/>);
...
//# sourceMappingURL=DirectorySection.test.jsx.map