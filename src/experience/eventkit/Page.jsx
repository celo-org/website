...
export default function BrandKitPage({ sections, title, path }) {
    return (<Page pages={PAGES} sections={sections} title={`EventKit / ${title}`} kitName="EventKit" path={path} metaDescription={metaDescription} ogImage={openGraph.src}/>);
}
