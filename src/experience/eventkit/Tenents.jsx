...
const DESIGN_FOR_ALL = frontMatter(designForAll);
const HUMILITY = frontMatter(embodyHumility);
const INNOVATING = frontMatter(innovatingOnMoney);
const BEAUTY = frontMatter(strivingForBeauty);
function Tenent({ body, title, description, image }) {
...
export function DesignForAll() {
    ...
    return (<Tenent body={body} title={attributes.title} description={attributes.description} image={designForAllImg}/>);
}
export function EmbodyHumility() {
    const { body, attributes } = HUMILITY;
    return (<Tenent body={body} title={attributes.title} description={attributes.description} image={embodyHumilityImg}/>);
}
export function InnovatingOnMoney() {
    const { body, attributes } = INNOVATING;
    return (<Tenent body={body} title={attributes.title} description={attributes.description} image={innovatingOnMoneyImg}/>);
}
export function StrivingForBeauty() {
    const { body, attributes } = BEAUTY;
    return (<Tenent body={body} title={attributes.title} description={attributes.description} image={strivingForBeautyImg}/>);
}
//# sourceMappingURL=Tenents.jsx.map