...
class StakeoffTerms extends React.PureComponent {
    render() {
        const { t } = this.props;
        return (<>
        <OpenGraph title={t("gameOfStakesTermsTitle")} path={NameSpaces.terms} description={t("gameOfStakesTermsMetaDescription")}/>
...
//# sourceMappingURL=StakeOffTerms.jsx.map