...
export default function Roledex(props) {
    ...
    return (<>
      ...
      {isMobile ? (<DropDownGroup data={[
          ...
          {props.sheets.map(({ sys, fields }, i) => (<SelectOption onPress={setCurrent} id={i} key={sys.id} title={fields.title} active={!isInTransition && index === i}/>))}
        </div>)}
...
//# sourceMappingURL=Roledex.jsx.map