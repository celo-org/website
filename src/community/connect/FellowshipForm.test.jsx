...
describe("FellowshipForm", () => {
    describe("when visitor tries submiting without filling out form", () => {
        it("shows validation errors", async () => {
            const { getByText, queryAllByText } = render(<TestProvider>
          <FellowshipForm />
        </TestProvider>);
    ...
    describe("when visitor presses submit after filling out the form", () => {
        it("does not show errors", async () => {
            const { getByText, queryAllByText, getByLabelText } = render(<TestProvider>
          <FellowshipForm />
        </TestProvider>);
...
//# sourceMappingURL=FellowshipForm.test.jsx.map