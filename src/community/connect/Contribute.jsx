...
function Contribute({ t }) {
    return (<View style={[styles.darkBackground, styles.keepOnScreen]}>
      <GridRow mobileStyle={[styles.proposalArea, standardStyles.blockMarginBottomTablet]}>
        <Cell span={Spans.half} style={styles.verticalCenter}>
          <View style={styles.proposalText}>
            ...
            <Button kind={BTN.NAKED} size={SIZE.normal} text={t("contribute.button")} target={"_cfp"} href={"https://medium.com/celoOrg/call-for-proposals-the-celo-fellowship-3c43b06b10f9"}/>
          </View>
        </Cell>
...
//# sourceMappingURL=Contribute.jsx.map