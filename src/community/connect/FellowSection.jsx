...
class FellowSection extends React.PureComponent {
    render() {
        const { t } = this.props;
        return (<>
        <FellowViewer />
        <GridRow allStyle={standardStyles.centered} nativeID={hashNav.connect.fellowship} desktopStyle={[standardStyles.sectionMarginTop, standardStyles.blockMarginBottomTablet]} tabletStyle={[standardStyles.sectionMarginTablet, standardStyles.blockMarginBottomTablet]} mobileStyle={[standardStyles.sectionMarginMobile, standardStyles.blockMarginBottomMobile]}>
...
//# sourceMappingURL=FellowSection.jsx.map