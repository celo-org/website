...
const fellows = [
    {
        ...
        quote: "“My grandparents were Mexican migrant farmers—I saw first hand how access to basic financial tools can change lives.”",
        text: "Xochitl recently graduated from Stanford Graduate School of Business. Prior to Stanford, she was a Director at Cisco where she led expansion into 26 Emerging Markets. She is leveraging her background and expertise to explore Mexico as a potential launch country for Celo. Her key activities include country landscaping, user research, pilot scoping and implementation, analysis and final recommendations.",
    },
    {
        ...
        role: "Engineering",
        color: colors.purpleScreen,
        quote: "“As part of my thesis, I explored how to successfully maintain user privacy as we move to decentralized financial systems.”",
        text: (<>
        ...
        <Button kind={BTN.INLINE} text={"EigenTrust"} href={"https://en.wikipedia.org/wiki/EigenTrust"} target="_new"/>{" "}
        Computation. His fellowship built on the work of Celo co-founder{" "}
        <Button kind={BTN.INLINE} text={"Sep Kamvar"} href={"https://en.wikipedia.org/wiki/Sepandar_Kamvar"} target="_new"/>
    ...
    },
    {
        ...
        text: "James applied his skills as a Fixer to organize comprehensive field research for the entire cLabs team, interviewing 20 Venezuelan migrants in Colombia. The ethnographic interviews focused in particular on individual perspectives on the prolific informal remittance market and the process of becoming unbanked in the transition from Venezuela to Colombia. This immersive learning experience was instrumental in increasing empathy and understanding with our end users.",
    },
];
class FellowViewer extends React.PureComponent {
    componentDidMount() {
        setTimeout(() => window.dispatchEvent(new Event("resize")), 1);
    }
    render() {
        return (<View style={ScreenSizes.MOBILE === this.props.screen
                ? standardStyles.sectionMarginTopMobile
                : standardStyles.sectionMarginTop}>
        <Fade distance={"20px"}>
          <Carousel heightMode={"current"} autoplay={false} dragging={true} swiping={true} renderCenterLeftControls={null} renderCenterRightControls={null} renderBottomCenterControls={PagingDots}>
...
//# sourceMappingURL=FellowViewer.jsx.map