...
export function CommunityPage() {
    ...
    return (<>
        <OpenGraph path="/community" title={t("pageTitle")} description={"Celo is a financial system that allows more people to participate, and we invite you to join the conversation and our community. Diverse perspectives and inclusive conversations welcomed."} image={preview}/>
        <View>
          <CoverArea />
          <Tenets />
...
//# sourceMappingURL=CommunityPage.jsx.map