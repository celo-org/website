...
export default function PagingDots(props) {
    return (<View style={styles.dotContainer}>
      {Array(props.slideCount)
            ...
            return (<TouchableOpacity activeOpacity={0.85} key={index} style={[styles.dot, isActive ? styles.active : styles.inactive]} onPress={goToSlide}/>);
        })}
    </View>);
}
const DOT_SIZE = 13;
...
//# sourceMappingURL=PagingDots.jsx.map