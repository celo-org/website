...
export default function RisingPinWheelForm() {
    return (<View style={standardStyles.darkBackground}>
      <GridRow desktopStyle={standardStyles.sectionMarginTop} tabletStyle={standardStyles.sectionMarginTopTablet} mobileStyle={standardStyles.sectionMarginTopMobile} allStyle={[standardStyles.centered, standardStyles.blockMarginBottom]}>
...
//# sourceMappingURL=RisingPinWheelForm.jsx.map