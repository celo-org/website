...
export default function Main() {
    ...
    return (<View>
      ...
      <View style={standardStyles.darkBackground}>
        ...
        <GridRow desktopStyle={standardStyles.sectionMarginBottom} tabletStyle={standardStyles.sectionMarginBottomTablet} mobileStyle={standardStyles.sectionMarginBottomMobile} allStyle={standardStyles.centered}>
      ...
      <Affirmations />
      <BeautifulQuote color={colors.white} imgSource={aguaComunidad} quote={"The Alliance for Prosperity gives us a fresh chance to build, interoperate, and secure new financial services applications"} citation={<span>Gigi Gatti, Grameen Foundation</span>}/>
      <Benefits />
      <ArticleData title={t("mediumArticlesTitle")} tagged={"alliance"}/>
      <BeautifulQuote color={colors.dark} imgSource={fences} quote={"Our hope is that this Alliance will start unlocking the potential of internet money"} citation={<span>Katie Haun, Andreessen Horowitz</span>}/>
