...
export function CheckboxWithLabel({ checked, onPress, name, label, }) {
    return (<View style={standardStyles.row}>
...
function Checkbox({ checked, onPress, name }) {
    return (<View style={checkBoxStyles.border}>
      <Text style={[
...
//# sourceMappingURL=CheckboxWithLabel.jsx.map