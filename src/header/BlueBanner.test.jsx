...
describe("BlueBanner", () => {
    ...
    describe("when isVisible true", () => {
        it("renders with height", () => {
            const { getByRole, getByTestId } = render(<BlueBanner link="/testing" isVisible={true} getRealHeight={getHeight}>
          Say Hi
        </BlueBanner>);
    ...
    describe("when isVisible is false", () => {
        it("is not visible due to height", () => {
            const { getByTestId } = render(<BlueBanner link="/testing" isVisible={false} getRealHeight={getHeight}>
          Say Hi
        </BlueBanner>);
...
//# sourceMappingURL=BlueBanner.test.jsx.map