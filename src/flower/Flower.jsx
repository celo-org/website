...
export default function Flower() {
    ...
    React.useEffect(() => {
        ...
        const outlineFlower = setImage(viewCtx, canvasWidth, canvasHeight, OUTLINE_FLOWER_SRC[screen], 0);
        const handleScroll = () => {
    ...
    return (<View style={[styles.breathe, isMobile && styles.breatheMobile]}>
      <canvas ref={canvasRef} width="1270" height="1270" style={{ maxWidth: "100%" }}/>
    </View>);
}
function scaleFromCenter(viewCtx, factor) {
