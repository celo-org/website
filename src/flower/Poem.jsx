...
export default function Poem() {
    ...
    return (<View style={[styles.root, isDesktop && styles.desktopRoot, isTablet && styles.tabletRoot]}>
      <H4 style={[textStyles.italic, standardStyles.elementalMarginBottom]}>For Value Flowers</H4>
      {STANZAS.map((verse) => (<Text key={verse.slice(0, 20)} style={fonts.p}>
          {verse}
        </Text>))}
    </View>);
}
