...
export default function DownloadCover() {
    ...
    return (<View style={styles.zIndex}>
      <GridRow allStyle={standardStyles.centered} desktopStyle={standardStyles.sectionMargin} tabletStyle={standardStyles.sectionMarginTablet} mobileStyle={standardStyles.blockMarginMobile}>
        <Cell span={Spans.three4th} tabletSpan={Spans.full} style={[
            styles.container,
          ...
          <View style={[styles.flex1, styles.content, isMobile && standardStyles.centered]}>
            ...
            <Button onPress={confirm} style={styles.button} iconLeft={<Android size={18} color={colors.primary}/>} kind={BTN.NAKED} size={SIZE.big} text={"Android"} target="_blank" href={CeloLinks.playStoreDevWallet}/>
            <Button onPress={confirm} style={styles.button} iconLeft={<Apple size={18} color={colors.primary}/>} kind={BTN.NAKED} size={SIZE.big} text={"iOS"} target="_blank" href={CeloLinks.appStoreDevWallet}/>
            <Button onPress={confirm} style={styles.button} iconLeft={<Web color={colors.primary} size={18}/>} kind={BTN.NAKED} size={SIZE.big} target="_blank" text={"Web"} href={CeloLinks.alfajoresWebWallet}/>
          </View>
