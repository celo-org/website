...
export default React.memo(function BeautifulQuote(props) {
    return (<ImageBackground source={{ uri: props.imgSource.src }} style={[styles.image, standardStyles.centered]} resizeMode={"cover"}>
...
//# sourceMappingURL=BeautifulQuote.jsx.map