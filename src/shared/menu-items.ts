...
export enum CeloLinks {
  ...
  faucetGrande = "https://docs.google.com/forms/d/1n6m-nMjjDn2RpBDadMMqYpf5DzDTOeRk1dhDJrLFdO4/viewform",
  ...
  tutorial = "https://docs.celo.org/cli/account#celocli-accountnew",
