...
export default class VideoModal extends React.Component {
    ...
    render() {
        ...
        {this.props.previewImage ? (<TouchableHighlight onPress={this.play}>
            <View style={styles.container}>
              <AspectRatio ratio={300 / 958} style={{ height: HEIGHT }}>
                <Image source={{ uri: this.props.previewImage }} resizeMode="cover" style={styles.image}/>
              </AspectRatio>
              <View style={styles.playButton}>
                <PlayCircle />
              </View>
            </View>
          </TouchableHighlight>) : (this.props.children(this.play))}
        {this.state.isClient && (<ReactModal isOpen={this.state.playing} onRequestClose={this.close} style={{ overlay: htmlStyles.cinema, content: htmlStyles.modalContent }} aria={{
                    labelledby: "Video",
            ...
            <YouTube videoId={this.props.videoID} opts={opts} onReady={onReady} onEnd={this.onEnd}/>
          </ReactModal>)}
      </>);
    }
}
...
//# sourceMappingURL=VideoModal.jsx.map