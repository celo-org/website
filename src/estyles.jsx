...
const body = css(fontInfo.p, { lineHeight: `${fontInfo.p.lineHeight}px` });
...
export const fonts = {
    body,
    h1: css(fontInfo.h1, headingReset, { lineHeight: `${fontInfo.h1.lineHeight}px` }),
    h1Mobile: css(fontInfo.h1Mobile, headingReset, {
        lineHeight: `${fontInfo.h1Mobile.lineHeight}px`,
    }),
    h2: css(headingReset, fontInfo.h2, { lineHeight: `${fontInfo.h2.lineHeight}px` }),
    h3: css(headingReset, fontInfo.h3, { lineHeight: `${fontInfo.h3.lineHeight}px` }),
    h4: css(headingReset, fontInfo.h4, { lineHeight: `${fontInfo.h4.lineHeight}px` }),
    h5: css(headingReset, fontInfo.h5, { lineHeight: `${fontInfo.h5.lineHeight}px` }),
    h6: css(headingReset, fontInfo.h6, { lineHeight: `${fontInfo.h6.lineHeight}px` }),
    legal: css(headingReset, fontInfo.legal, { lineHeight: `${fontInfo.legal.lineHeight}px` }),
    navigation: css(fontInfo.navigation, {
...
//# sourceMappingURL=estyles.jsx.map