...
function CeloRewards({}) {
    ...
    return (<>
      <OpenGraph title={t("title")} path={menuItems.CELO_REWARDS.link} description={t("description.first")}/>
      <View style={styles.container}>
        <TitleAndDescription title={t("title")} description={<>
              {t("description.first")}
              {"\n"}
...
//# sourceMappingURL=CeloRewards.jsx.map