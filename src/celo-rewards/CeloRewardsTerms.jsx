...
(function (ComponentType) {
    ComponentType[ComponentType["BOLD"] = 0] = "BOLD";
    ComponentType[ComponentType["LINK"] = 1] = "LINK";
})(ComponentType || (ComponentType = {}));
const bold = () => ({ type: ComponentType.BOLD });
const link = (uri) => ({
    type: ComponentType.LINK,
    link: uri,
});
const decorateText = (t, key, components) => {
    return (<Trans i18nKey={NameSpaces.celoRewards} defaults={t(key)}>
      {components.map((component, i) => {
            if (component.type === ComponentType.BOLD) {
                return <Text key={i} style={styles.bold}/>;
            }
            if (component.type === ComponentType.LINK) {
                return (<InlineAnchor target="_blank" href={component.link} style={styles.link} key={i}>
              {" "}
            </InlineAnchor>);
            }
        })}
...
function CeloRewardsTerms() {
    ...
    return (<>
      <OpenGraph title={t("title")} path={menuItems.CELO_REWARDS_TERMS.link} description={t("description.first")}/>
      <View style={styles.container}>
        ...
        <TitleAndDescription title={t("terms.howItWorks.title")} description={<Ol>
        ...
        <TitleAndDescription title={t("terms.moreDetails.title")} description={<Ul>
              <Li style={styles.listItem}>
        ...
        <TitleAndDescription title={t("terms.celoAndCusd.title")} description={<Ul>
              <Li style={styles.listItem}>{t("terms.celoAndCusd.1")}</Li>
              <Li style={styles.listItem}>{t("terms.celoAndCusd.2")}</Li>
            </Ul>}/>
        <TitleAndDescription title={t("terms.rewardsTroubleShoot.title")} description={<>
        ...
        <TitleAndDescription title={t("terms.notices.title")} description={decorateText(t, "terms.notices.body", [
            link(CeloLinks.communityFund),
            link(CeloLinks.celoRewardsDiscussion),
        ])}/>
        <TitleAndDescription title={t("terms.liability.title")} description={t("terms.liability.body")}/>
      </View>
    </>);
}
...
//# sourceMappingURL=CeloRewardsTerms.jsx.map