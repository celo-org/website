...
const DESCRIPTION = "Join us in building financial system that creates the conditions for prosperity for all. We are growing a team with all kinds of different perspectives, experiences and backgrounds to create products that are used and loved by people all around the world.";
class JoinPage extends React.PureComponent {
    render() {
        const { t } = this.props;
        return (<>
        <OpenGraph path={menuItems.JOBS.link} title={t("pageTitle")} description={DESCRIPTION} image={previewImage}/>
            ...
            <View style={styles.heading}>
              ...
              <View style={[styles.cloud]}>
                <Fade delay={20} distance={"20px"}>
                  <Button kind={BTN.PRIMARY} text={t("exploreRoles")} target="_blank" href={"https://clabs.co/careers"} size={SIZE.big} align={"center"}/>
                </Fade>
              </View>
            </View>
            <Rise />
...
//# sourceMappingURL=JoinPage.jsx.map