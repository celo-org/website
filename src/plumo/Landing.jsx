...
const PLUMO_FORM = "https://docs.google.com/forms/d/e/1FAIpQLScZswraVVC91RwToo_9qm-1QzGrxp7yjVeM2wzdTbL5T_lAgQ/viewform";
export default function PlumoLanding(props) {
    const { t } = useTranslation('plumo');
    return (<>
      <OpenGraph image={props.openGraph?.fields?.file?.url} title={props.title} description={props.description} path="/plumo"/>
      <nav css={navBar}>
        <Link2 href="/">
      ...
      <div css={rootCss}>
        ...
        {props.sections?.map((section) => {
            if (section.sys.contentType.sys.id === "grid-row") {
                ...
                return (<GridRow key={section.sys.id} id={fields.id} columns={fields.columns} css={css(fields.cssStyle)}>
