...
export default function Landing() {
    ...
    return (<View style={styles.root}>
      ...
      <Cover />
      <GridRow desktopStyle={standardStyles.blockMarginTop} tabletStyle={standardStyles.blockMarginTopTablet} mobileStyle={standardStyles.elementalMarginTop} allStyle={standardStyles.centered}>
      ...
      <GridRow desktopStyle={standardStyles.blockMarginBottom} tabletStyle={standardStyles.blockMarginBottomTablet} mobileStyle={standardStyles.blockMarginBottomMobile}>
        <Adventure source={sendToPhoneImg} title={t("adventure1.title")} text={t("adventure1.text")} link={{ href: "https://valoraapp.co/3j0mTjS", text: t("adventure1.link") }}/>
        <Adventure source={nonProfitIMG} title={t("adventure2.title")} text={t("adventure2.text")} link={{ href: "https://valoraapp.co/3l5XLtC", text: t("adventure2.link") }}/>
        <Adventure source={valora} title={t("adventure3.title")} text={t("adventure3.text")} link={{ href: "https://valoraapp.com", text: t("adventure3.link") }} imageStyle={isDesktop ? styles.valoraDesktop : styles.valora}/>
      </GridRow>
      ...
      <GridRow>
        <ContentPreview title={t("lesson1")} time={t("minutes", { count: 3 })} href={"https://coinbase.com/earn/celo/lesson/1"} src={lesson1Image}/>
        <ContentPreview title={t("lesson2")} time={t("minutes", { count: 2 })} href={"https://coinbase.com/earn/celo/lesson/2"} src={lesson2Image}/>
        <ContentPreview title={t("lesson3")} time={t("minutes", { count: 3 })} href={"https://coinbase.com/earn/celo/lesson/3"} src={lesson3Image}/>
      </GridRow>
    </View>);
}
function ContentPreview({ title, time, href, src }) {
    return (<Cell span={Spans.third}>
