...
import { Image, StyleSheet, unstable_createElement as createElement, View, } from "react-native-web";
...
class VideoCover extends React.PureComponent {
    state = {
        isHovering: false,
        supportsVideo: false,
    };
    ...
    render() {
        ...
        <View style={styles.background}>
          <Video style={[styles.video, this.state.isHovering && styles.videoHover]} muted={true} autoPlay={true} loop={true} poster="/images/AboutPreview.jpg">
            {this.state.supportsVideo && (<source src="https://storage.googleapis.com/celo_whitepapers/about-video.mp4" type="video/mp4"/>)}
            <Image resizeMode="cover" source={{ uri: "/images/AboutPreview.jpg" }} style={standardStyles.image}/>
          </Video>
        </View>
        <View style={[styles.overlay, standardStyles.centered]}>
          <VideoModal videoID="kKggE5OvyhE" ariaDescription="Video: What if money were beautiful?">
            {(onPlay) => (<Hoverable onHoverIn={this.onHoverStart} onHoverOut={this.onHoverEnd} onPress={onPlay}>
                <View style={[
                    standardStyles.centered,
                    styles.interactive,
                    this.state.isHovering && styles.hover,
                ]}>
                  <H1 ariaLevel={"2"} style={[
                    textStyles.invert,
                    styles.title,
                    textStyles.center,
...
//# sourceMappingURL=VideoCover.jsx.map