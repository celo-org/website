...
import { renderIgnoringUnstableFlushDiscreteUpdates, TestProvider, } from "src/_page-tests/test-utils";
import About from "src/about/About";
describe("About", () => {
    it("includes element with #contributors id", async () => {
        renderIgnoringUnstableFlushDiscreteUpdates(<TestProvider>
        <About contributors={[]}/>
      </TestProvider>);
...
//# sourceMappingURL=About.test.jsx.map