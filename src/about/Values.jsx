...
function Values({ t, screen }) {
    ...
    return (<>
      ...
      <GridRow desktopStyle={[standardStyles.sectionMarginBottom, standardStyles.centered]} tabletStyle={[standardStyles.sectionMarginBottomTablet, styles.pullRight]} mobileStyle={standardStyles.sectionMarginBottomMobile}>
        <Cell span={Spans.half} tabletSpan={Spans.three4th}>
          <View style={[
...
//# sourceMappingURL=Values.jsx.map