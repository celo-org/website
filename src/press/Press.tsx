...
const logos: Logo[] = [
  {
    ...
    size: {},
    alt: "The Block",
    url: "https://www.theblockcrypto.com/post/94012/celo-stablecoin-morgan-beller-advisor",
  },
  {
    alt: "Wall Street Journal",
    source: wsj,
    size: { height: 50, width: 180 },
    url: "https://www.wsj.com/articles/startup-celo-aims-to-make-crypto-accessible-to-mainstream-mobile-users-11554204600",
  },
  {
    alt: "Fortune",
    source: fortune,
    size: {},
    url: "https://fortune.com/2021/02/10/one-day-well-all-yawn-about-blockchain/",
  },
  {
    alt: "Decrypt",
    source: decrypt,
  ...
  },
  {
    ...
    source: techcrunch,
    size: {},
    url: "https://techcrunch.com/2018/09/05/googles-launchpad-studio-accelerator-welcomes-a-cohort-of-blockchain-and-finance-startups/",
  },
]
