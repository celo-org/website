...
class ValidatorPage extends React.PureComponent {
    render() {
        return (<View style={styles.container}>
        <OpenGraph image={previewImage} path={menuItems.BUILD.link} title={"Celo Validators"} description={"Learn how to run a node on Celo’s peer-to-peer network"}/>
        <Cover />
        <FullStack />
        <Features />
        <Engage />
...
//# sourceMappingURL=ValidatorPage.jsx.map