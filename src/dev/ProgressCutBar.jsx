...
const ProgressCutBar = React.memo(function ProgressCutBarFn({ bars, progress }) {
    ...
    return (<View style={[styles.barContainer]}>
      {blocks.map((width, i) => (<View key={i} style={[styles.bar]}>
...
//# sourceMappingURL=ProgressCutBar.jsx.map