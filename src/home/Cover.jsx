    ...
    return (<div css={css(rootCss, {
      ...
      <div css={useableArea}>
        ...
        {(isDesktop || isTablet) && (<picture>
            <object title={t("coverPhonesImage")} aria-label={t("coverPhonesImage")} type="image/svg+xml" data={examplePhones.src} width={1016} height={524}/>
          </picture>)}
      </div>
      <Press {...props.press}/>
