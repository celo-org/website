...
export function Radio({ selected, label, labelColor, icon, onValueSelected, value, disabled, colorWhenSelected, }) {
    const onSelect = () => onValueSelected(value);
    return (<TouchableOpacity onPress={onSelect} disabled={disabled}>
...
export function SectionHeader({ section }) {
    ...
    return (<View style={[standardStyles.blockMarginTopMobile, standardStyles.elementalMarginBottom]}>
      <Fade distance="20px">
...
export function NoneFound({ onPress, actionText, longText }) {
    return (<View style={[standardStyles.centered, styles.noJobs]}>
