...
export default React.memo(function ExchangeIconCELO({ size }) {
    return (<svg width={`${size}px`} height={`${size}px`} x="0px" y="0px" viewBox="0 0  100 100">
      <desc>Symbol for the Celo native asset (CELO)</desc>
      <path fill="#FBCC5C" d="M0,0h100v100H0V0z"/>
      <path fill="#F9B73E" d="M79.4,44c0-13-10.5-23.5-23.5-23.5c-9.6,0-17.9,5.8-21.5,14.1C26.2,38.3,20.5,46.5,20.5,56
      ...
      <path fill="#FFFFFF" d="M78.6,44c0-12.4-10.1-22.5-22.5-22.5c-9.4,0-17.4,5.7-20.8,13.9c-8,3.4-13.7,11.4-13.7,20.7
...
//# sourceMappingURL=ExchangeIconCELO.jsx.map