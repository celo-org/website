...
export default class MediumLogo extends React.PureComponent {
    static defaultProps = {
        height: 40,
    ...
    render() {
        ...
        if (wrapWithLink) {
            return (<a href={CeloLinks.mediumPublication} target="_blank" rel="noopener" style={{ lineHeight: `${height}px`, height: `${height}px` }}>
